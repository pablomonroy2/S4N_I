...
public class Dron implements IDron {
	...
	public Coordenada entrega(String movimientos){
		...
		/*for (int i = 0; i < movimientos.length(); i++) {
			char move = movimientos.charAt(i);*/
	...
	/* 
	 * @see co.com.s4n.interfaz.IDron#reporte(java.util.ArrayList)
	 */
	public void reporte(ArrayList<Coordenada> entregas)throws IOException{     
       
        BufferedWriter bw = new BufferedWriter(new FileWriter(new File("Files/out.txt")));
